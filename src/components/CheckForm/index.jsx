      ...
      <div className="w-full flex-col justify-start items-center gap-2.5 inline-flex">
        ...
        <div className="w-[400px] flex-col justify-center items-center flex">
            ...
            <div className="justify-center items-center gap-2 flex">
              ...
              >
                <div className="justify-center items-center gap-1 flex">
                  <div className="text-blue-500 text-base font-normal font-['Pretendard'] leading-tight">[필수]</div>
          ...
          <div className="w-[400px] py-2.5 justify-between items-center inline-flex">
            <div className="justify-center items-center gap-2 flex">
              ...
              >
                <div className="justify-center items-center gap-1 flex">
                  <div className="text-neutral-400 text-base font-normal font-['Pretendard'] leading-tight">[선택]</div>
                  <div className="text-neutral-400 text-base font-normal font-['Pretendard'] leading-tight">
                    혜택 및 마케팅 정보 수신 동의
                  </div>
                </div>
        ...
        <div className="w-full">
          <div className="w-full">
              ...
              <div className="w-full items-center flex flex-col">
                <div className="w-full items-center justify-center flex flex-col">
                  <p className="w-[362px] text-gray-800 text-sm font-normal font-['Pretendard'] leading-tight mb-[34px] mt-[28px]">
                    법률문제는 만 14세 미만 아동이 스스로 판단하기 힘든 복잡한 문제
                    <br />
                    <span>일 수 있습니다.</span>
                    <span className="text-red-500 text-sm font-semibold font-['Pretendard'] leading-tight">
                      112 경찰청&nbsp;
                    </span>
                    <span className="text-gray-800 text-sm font-normal font-['Pretendard'] leading-tight">또는</span>
                    <span className="text-red-500 text-sm font-semibold font-['Pretendard'] leading-tight">
                      &nbsp;1577-1391 아동보호전문기관
                    </span>
            ...
            <div className="w-[400px] h-12 relative mt-[44px]">
              <div className="w-[400px] h-12 rounded-md bg-blue-500 cursor-pointer"></div>
              <Button
                disabled={!isChecked}
                className="left-[185px] top-[14px] absolute text-center text-base font-semibold font-['Pretendard'] leading-tight text-white cursor-pointer"
              >
                다음
              </Button>
            </div>
